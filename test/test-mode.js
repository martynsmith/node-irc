...
test('various origins and types of chanmodes get handled correctly', function (t) {
    ...
    var expected = [
        ...
        },
        {
            ...
            users: { testbot: '@' },
            mode: '+ntb',
            modeParams: { b: ['*!*@AN.IP.1', '*!*@AN.IP.2'], n: [], t: [] },
        },
        {
            key: '#channel',
            serverName: '#channel',
            users: { testbot: '@' },
            mode: '+ntb',
            modeParams: { b: ['*!*@AN.IP.1', '*!*@AN.IP.2', '*!*@AN.IP.3'], n: [], t: [] },
        },
        {
            key: '#channel',
            serverName: '#channel',
            users: { testbot: '@' },
            mode: '+ntb',
            modeParams: { b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
        },
        {
            key: '#channel',
            serverName: '#channel',
            users: { testbot: '@' },
            mode: '+ntbf',
            modeParams: { f: ['[10j]:15'], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
        },
        {
            key: '#channel',
            serverName: '#channel',
            users: { testbot: '@' },
            mode: '+ntbf',
            modeParams: { f: ['[8j]:15'], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
        },
        {
        key: '#channel',
        serverName: '#channel',
        ...
        users: { testbot: '@' },
        mode: '+ntbj',
        modeParams: { j: ['3:5'], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbj',
        modeParams: { j: ['2:5'], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        ...
        users: { testbot: '@' },
        mode: '+ntbp',
        modeParams: { p: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbps',
        modeParams: { s: [], p: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbpsK',
        modeParams: { K: [], s: [], p: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbsK',
        modeParams: { K: [], s: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbK',
        modeParams: { K: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
        {
        key: '#channel',
        serverName: '#channel',
        users: { testbot: '@' },
        mode: '+ntbKF',
        modeParams: { F: [], K: [], b: ['*!*@AN.IP.1', '*!*@AN.IP.3'], n: [], t: [] },
    },
    ];

    mock.server.on('connection', function () {
        mock.send(':localhost 001 testbot :Welcome!\r\n');
        mock.send(':localhost 005 testbot MODES=12 CHANTYPES=# PREFIX=(ohv)@%+ '
