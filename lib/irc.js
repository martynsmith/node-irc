...
function Client(server, nick, opt) {
    ...
    self.opt = {
        ...
        userName: opt.userName || 'nodebot',
        realName: opt.realName || 'nodeJS IRC client',
        port: opt.port || 6667,
        debug: opt.debug || false,
        showErrors: opt.showErrors || false,
        autoRejoin: opt.autoRejoin || true,
        autoConnect: opt.autoConnect || true,
        channels: opt.channels || [],
        retryCount: opt.retryCount || null,
        retryDelay: opt.retryDelay || 2000,
