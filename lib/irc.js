           ...
           if (self.conn.authorized ||
              ...
              self.conn.setEncoding('utf-8');
                ...
                if (typeof self.opt.webirc.ip !== 'undefined') {
                	self.send("WEBIRC","webirc password",self.opt.userName,self.opt.webirc.host,self.opt.webirc.ip);
                }//for safety reasons, webirc password should be writed manually here
