        ...
        switch ( message.command ) {
            ...
            case "MODE":
                ...
                modeList.forEach(function(mode) {
                    ...
                    if ( mode in self.prefixForMode ) {
                        ...
                        if ( adding && channel.users[user]!=undefined) {
                        ...
                        else if(channel.users[user]!=undefined) {
            ...
            case "PRIVMSG":
                ...
                if(text!=undefined) {
                    ...
                    util.log('IRC exception: PRIVMSG without text');
                }
                break;
            case "INVITE":
                var from = message.nick;
            ...
            default:
                ...
                self.emit('raw_'+message.command, message);
                break;
        }
    }); // }}}
