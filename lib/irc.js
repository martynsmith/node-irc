        ...
        switch ( message.command ) {
            ...
            case "rpl_whoischannels":
                ...
                while (channum < whoischannels.length) {
                    if (whoischannels[channum].charAt(0) === '+' || whoischannels[channum].charAt(0) === '@') {
...
Client.prototype.whois = function(nickname, callback) { // {{{
    ...
    var whoisuser = this.once('whoisuser', function(nickname,username,host,realname) {
        whois.nickname = nickname;
        whois.username = username;
        whois.host = host;
        whois.realname = realname;
    });
    var whoischannels = this.once('whoischannels', function(nickname, channels) {
        whois.channels = channels;
    });
    var whoisauthed = this.once('whoisauthed', function(nickname, authname) {
        whois.auth = authname;
    });
    var endofwhois = this.once('endofwhois', function() {
